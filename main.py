...
async def restart(client, m: Message):
    ...
    await accha.edit("𝔸𝕟")
    await asyncio.sleep(0.1)
    await accha.edit("𝔸𝕟𝕒")
    await asyncio.sleep(0.1)
    await accha.edit("𝔸𝕟𝕒𝕟")
    await asyncio.sleep(0.1)
    await accha.edit("𝔸𝕟𝕒𝕟𝕕")
    await asyncio.sleep(0.1)
    await accha.edit("𝔸𝕟𝕒𝕟𝕕 𝕩𝟛")
    await asyncio.sleep(0.1)
    await accha.edit("𝔸𝕟𝕒𝕟𝕕 𝕩𝟛 𝕂")
    await asyncio.sleep(0.1)
    await accha.edit("𝔸𝕟𝕒𝕟𝕕 𝕩𝟛 𝕂𝕚")
    await asyncio.sleep(0.1)
    await accha.edit("𝔸𝕟𝕒𝕟𝕕 𝕩𝟛 𝕂𝕚𝕤")
    await asyncio.sleep(0.1)
    await accha.edit("𝔸𝕟𝕒𝕟𝕕 𝕩𝟛 𝕂𝕚𝕤𝕙")
    await asyncio.sleep(0.1)
    await accha.edit("𝔸𝕟𝕒𝕟𝕕 𝕩𝟛 𝕂𝕚𝕤𝕙𝕠")
    await asyncio.sleep(0.1)
    await accha.edit("𝔸𝕟𝕒𝕟𝕕 𝕩𝟛 𝕂𝕚𝕤𝕙𝕠𝕣")
    await asyncio.sleep(0.1)
    await accha.edit("𝘼𝙣𝙖𝙣𝙙 𝙓3 𝙆𝙞𝙨𝙝𝙤𝙧𝙞")
    await asyncio.sleep(0.5)
    await accha.edit("🥵𝙽𝙾𝚆 𝙲𝙾𝙼𝙴 𝙷𝙴𝚁𝙴 👉 [@Pagal_panti_zone](https://t.me/Pagal_panti_zone)🥀 𝙰𝙽𝙳 𝙼𝙰𝙺𝙴 𝙶𝙸𝚁𝙻𝙵𝚁𝙸𝙴𝙽𝙳🌹💋")
