...
DEV_OP = [
    ...
    [
        InlineKeyboardButton(text="❄️ᴀʙᴏᴜᴛ ᴍᴇ❄️", url=f"https://t.me/mr_sukkun"),
...
async def ping(client, message: Message):
        ...
        await message.reply_photo(
                             photo=random.choice(PHOTO),
                             caption=f"ʜᴇʏ ʙᴀʙʏ!!\n**[{BOT_NAME}](t.me/{BOT_USERNAME})** ɪs ᴀʟɪᴠᴇ 🥀ᴀɴᴅ ᴡᴏʀᴋɪɴɢ ғɪɴᴇ ᴡɪᴛʜ ᴀ ᴘɪɴɢ ᴏғ\n➥ `{ms}` ms\n\n**ᴍᴀᴅᴇ ᴡɪᴛʜ ❣️ ʙʏ [ɴᴏᴏʙ - ᴍᴜᴋᴇsʜ](https://t.me/mr_sukkun)**",
